...
#   -files ../ScriptFiles/RTLCompilerI.tcl
#   -overwrite
#   -logfile ../LoggerFiles/RTLCompilerI.log
#   -cmdfile ../LoggerFiles/RTLCompilerI.cmd

source ../ScriptFiles/RTLCompilerI.tcl
...
# set HDLFILES [list ../SourceFiles/SARImprVerilog.v]
# set HDLFORMATRC -v2001
# set HDLFORMATDC verilog
# set TOPLEVEL SARImprVerilog
# set PARAMETER [list 4 8]
