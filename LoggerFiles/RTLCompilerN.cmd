...
#   -files ../ScriptFiles/RTLCompilerN.tcl
#   -overwrite
#   -logfile ../LoggerFiles/RTLCompilerN.log
#   -cmdfile ../LoggerFiles/RTLCompilerN.cmd

source ../ScriptFiles/RTLCompilerN.tcl
...
# set HDLFILES [list ../SourceFiles/SARNormVerilog.v]
# set HDLFORMATRC -v2001
# set HDLFORMATDC verilog
# set TOPLEVEL SARNormVerilog
