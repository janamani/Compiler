...
export NETLIST=../OutputFiles/SARTimer4Verilog.v										
export LVSFILE=../OutputFiles/SARTimer4Verilog.spi
export SCSTEMP=../ReportFiles/SARTimer4Verilog.spi
export SCSFILE=../OutputFiles/SARTimer4Verilog.scs
export SPPLOG=../LoggerFiles/SPPTX.log
export V2LVSLOG=../LoggerFiles/V2LVSTX.log
export V2SCSLOG=../LoggerFiles/V2SCSTX.log
export POWERNET=VCC
