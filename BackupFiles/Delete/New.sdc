...
set_load -pin_load 0.025 {SAROutI[0]}
set_load -pin_load 0.030 {SAROutI[1]}
set_load -pin_load 0.050 {SAROutI[2]}
set_load -pin_load 0.070 {SAROutI[3]}
set_load -pin_load 0.130 {SAROutI[4]}
set_load -pin_load 0.250 {SAROutI[5]}
set_load -pin_load 0.450 {SAROutI[6]}
set_load -pin_load 0.880 {SAROutI[7]}
